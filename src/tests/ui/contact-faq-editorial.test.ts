...
describe('Contact and homepage FAQ editorial presentation', () => {
  ...
  it('keeps contact content compact, accessible, and limited to the official email', () => {
    ...
    expect(contactSource).toContain('ikmikominfo@gmail.com')
  ...
  it('uses the reference FAQ copy, native disclosures, and official contact address', () => {
    ...
    expect(homeSource).toContain('mailto:ikmikominfo@gmail.com')
