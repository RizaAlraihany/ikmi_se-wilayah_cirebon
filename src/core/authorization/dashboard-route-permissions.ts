...
export const dashboardRoutePermissions: readonly DashboardRoutePermission[] = [
  ...
  { path: '/admin/campaign/pages', permission: 'cms.view', roles: KOMDIGI_DASHBOARD_ROLE_IDS },
  ...
  { path: '/admin/cms/settings', permission: null, roles: ORGANIZATION_DASHBOARD_ROLE_IDS },
  { path: '/admin/cms/categories', permission: 'cms.update', roles: KOMDIGI_DASHBOARD_ROLE_IDS },
